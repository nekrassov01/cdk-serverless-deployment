...
for var in SERVICE ENVIRONMENT BRANCH BUCKET_NAME PRODUCTION_DISTRIBUTION_ID STAGING_DISTRIBUTION_ID STAGING_DISTRIBUTION_CLEANUP CONTINUOUS_DEPLOYMENT_POLICY_CUSTOM_HEADER FRONTEND_VERSION; do
  check_variable "$var"
done
